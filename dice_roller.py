...
#load in dice images
one = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice1.png")
two = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice2.png")
three = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice3.png")
four = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice4.png")
five = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice5.png")
six = Image.open("https://github.com/tsully54/Dice-Roller/blob/main/dice6.png")
